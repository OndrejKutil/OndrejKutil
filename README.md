...
### Skills & Technologies
- **Languages:** Python, SQL, basics of R and C++
...
#### [Machine Learning From Scratch](https://github.com/OndrejKutil/from_scratch)

Fundamental ML algorithms — for example neural networks, K-Means, and decision trees — implemented from the ground up in Python with only NumPy, no frameworks.
